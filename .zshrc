...
alias clean_hf="rm -rf /Users/pwolter/.cache/huggingface"
...
__conda_setup="$('/Users/pwolter/miniforge3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/pwolter/miniforge3/etc/profile.d/conda.sh" ]; then
        . "/Users/pwolter/miniforge3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/pwolter/miniforge3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
export MAMBA_EXE='/Users/pwolter/miniforge3/bin/mamba';
export MAMBA_ROOT_PREFIX='/Users/pwolter/miniforge3';
